...
class TestConfigBoundary:
    @pytest.mark.zentao("TC-S0887", domain="server/config", priority="P2")
    ...
    @pytest.mark.zentao("TC-S0888", domain="server/config", priority="P2")
    ...
    @pytest.mark.zentao("TC-S0889", domain="server/config", priority="P1")
    ...
    @pytest.mark.zentao("TC-S0890", domain="server/config", priority="P2")
    ...
    @pytest.mark.zentao("TC-S0891", domain="server/config", priority="P2")
    ...
    @pytest.mark.zentao("TC-S0900", domain="server/config", priority="P1")
    ...
    @pytest.mark.zentao("TC-S0901", domain="server/config", priority="P2")
    ...
    @pytest.mark.zentao("TC-S0902", domain="server/config", priority="P1")
    ...
    @pytest.mark.zentao("TC-S0903", domain="server/config", priority="P2")
    ...
    @pytest.mark.zentao("TC-S0904", domain="server/config", priority="P2")
