 ...
 *
 * v2 (2026-09): SubPipelineIcon / PluginIcon 迁移到品牌图标库
 *   @/components/icons（导航栏、运行树、节点面板共用），此处改为 re-export
 *   保持既有导入路径不变，消除同一概念两套图标的不一致。
 */

type IconProps = SVGProps<SVGSVGElement>;

export { PluginIcon, SubPipelineIcon } from '@/components/icons';
